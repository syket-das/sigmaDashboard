import { Avatar, Box, CircularProgress, Divider, List, ListItemAvatar, ListItemButton, ListItemText, Typography, useTheme } from '@mui/material';
...
const UniversityProfileContacts = () => {
  ...
  const {loading,error, contacts} = useSelector(state => state.universityProfile.contacts);
